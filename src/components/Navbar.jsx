...
import { AiOutlineSearch, AiOutlineLogout, AiOutlineLogin } from 'react-icons/ai'
  ...
  return (
    <div className='flex gap-2 md:gap-5 w-full mt-5 pb-7'>
      ...
      {currentUser ? (
        ...
        <Link className='rounded-lg flex justify-center items-center cursor-pointer' to='/login'>
          <AiOutlineLogin fontSize={30} />
        </Link>
  )
}
    </div >
